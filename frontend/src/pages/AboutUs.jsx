      ...
      <body class="bg-gray-200 rounded-lg m-[1%]">
        <div class="container mx-auto p-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div class="max-w-md">
              <img class="rounded-lg shadow-lg" src={Hero} alt="About Us" />
            </div>
            <div>
              <h2 class="text-2xl font-bold mb-4">Welcome to Gadget Grade</h2>
              ...
              <p class="text-gray-700 mb-4">Join our growing community of tech enthusiasts and let's collectively elevate the
